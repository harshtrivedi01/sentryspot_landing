        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
              ...
              <a href="/" className="text-white px-2 py-2 text-lg font-semibold  rounded-xl " id='home_fourth'>Log in</a>
              <a href="/" className="text-white hover:text-yellow-500 px-2 py-2 text-lg font-semibold border-2 rounded-xl">Sign up</a>
            </div>
