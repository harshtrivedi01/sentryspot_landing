  ...
  return (
    <>
      <div className=' bg-gray-100'>
        <div className=' py-9 px-5 flex gap-3 md:gap-10 md:justify-evenly flex-col md:flex-row'>
            <div className='  px-3 py-3 md:w-[500px]'>
                <div className=' flex flex-col gap-4'>
                    ...
                    <div className=' flex flex-wrap gap-4'>
                        <button className='  px-6 py-2 text-lg rounded-full font-bold hover:px-8 hover:shadow-2xl hover:shadow-slate-500' id='home_fourth'> Import Your Resume</button>
                        <button className=' text-white text-lg px-6 py-2 rounded-full  font-bold hover:px-8 hover:shadow-2xl hover:shadow-slate-500 ' id='home_third'> Build your Resume</button>
                    </div>
