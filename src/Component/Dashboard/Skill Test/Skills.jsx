  ...
  return (
    <div className="py-16 bg-gray-700">
      ...
      <div className="flex flex-wrap gap-7 px-5 py-5">
        ...
        {result && (
          <div className="bg-slate-700 rounded-xl shadow-2xl border-2 border-slate-600 px-5 py-4">
            <h3 className="text-3xl text-white font-semibold py-3">{result.skillName}</h3>
